...
if(get_option('mouseflow_script') == ''){
	echo '<td><img src="' .plugins_url('mouseflow-for-wordpress/gear_bad.png', dirname(__FILE__) ). '" >
		...
		Your Mouseflow tracking code is not yet installed. You can <a href="https://app.mouseflow.com/sign-in" target="_blank">find the tracking code on your Mouseflow-account</a>. If you don\'t yet have an account, you can easily <a href="https://mouseflow.com/sign-up/" target="_blank">create a Mouseflow-account for free</a>.
					</td>';
}
else{
	echo '<td><img src="' .plugins_url('mouseflow-for-wordpress/gear_good.png', dirname(__FILE__) ). '" >
